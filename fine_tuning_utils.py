...
import modeling
import tokenization_ns_kor as tokenization
...
def create_vocab(vocab_file, do_lower_case,hub_module): #spm_model_file, 
  ...
  #else:
  return tokenization.FullTokenizer.from_scratch(vocab_file=vocab_file, do_lower_case=do_lower_case)
        #spm_model_file=spm_model_file)
